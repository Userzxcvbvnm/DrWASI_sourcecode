...
def deduplicate_path_rename(filename, version="None"):
    print(f"Dedusplicating PATH_RENAME_result ...")
    outputfile = f"{DIR}/PATH_RENAME_final.txt"
    if version == "new":
        outputfile = f"{DIR}/new_version/PATH_RENAME_final.txt"
    elif version == "old":
        outputfile = f"{DIR}/old_version/PATH_RENAME_final.txt" 
    ...
    for record in records:
        ...
        msg = BugMetaPATH_RENAME(runtime=runtime, bugmsg=bugmsg, problemdir=problemdir)
        add_msg(msg_set, msg)
