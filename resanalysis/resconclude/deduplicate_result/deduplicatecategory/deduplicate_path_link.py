...
def deduplicate_path_link(filename, version="None"):
    print(f"Dedusplicating PATH_LINK_result ...")
    outputfile = f"{DIR}/PATH_LINK_final.txt"
    if version == "new":
        outputfile = f"{DIR}/new_version/PATH_LINK_final.txt"
    elif version == "old":
        outputfile = f"{DIR}/old_version/PATH_LINK_final.txt"  
    ...
    for record in records:
        ...
        msg = BugMetaPATH_LINK(runtime=runtime, bugmsg=bugmsg, problemdir=problemdir)
        add_msg(msg_set, msg)
