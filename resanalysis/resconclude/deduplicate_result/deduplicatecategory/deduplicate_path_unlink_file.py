...
def deduplicate_path_unlink_file(filename):
    print(f"Dedusplicating PATH_UNLINK_FILE_result ...")
    outputfile = f"{DIR}/PATH_UNLINK_FILE_final.txt"
    ...
    for record in records:
        ...
        msg = BugMetaPATH_UNLINK_FILE(runtime=runtime, bugmsg=bugmsg, problemdir=problemdir)
        add_msg(msg_set, msg)
