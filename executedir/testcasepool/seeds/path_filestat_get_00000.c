...
void path_filestat_get_1d3ff(const char *filename) {
    printf("Enter function path_filestat_get_1d3ff\n");
    ...
    printf("Leave path_filestat_get.\n");
}

int main() {
    printf("Enter function main\n");
    path_filestat_get_1d3ff("EXAMPLEDIR");
    return 0;
}
