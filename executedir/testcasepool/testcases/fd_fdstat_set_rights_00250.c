...
int fd_fdstat_set_rights_00250_7we45(int fd) {
    printf("Enter function fd_fdstat_set_rights_00250_7we45\n");

    __wasi_rights_t new_rights = __WASI_RIGHTS_FD_FILESTAT_SET_TIMES;
...
int main() {
    ...
    fd_fdstat_set_rights_00250_7we45(fd);
