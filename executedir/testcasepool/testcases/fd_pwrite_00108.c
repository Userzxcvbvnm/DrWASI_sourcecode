...
void fd_pwrite_00108_nEEKq(int fd) {
    printf("Enter function fd_pwrite_00108_nEEKq\n");
    off_t size = lseek(fd, 0, SEEK_END); 
    printf("Current file size before: %ld\n", size);

    
    struct iovec iov[1];
    iov[0].iov_base = "hPxReJmKuK2r7R3HJzPmMxXeyyRwWG0ju3QKmURGLcLlFwwV495pOaz5Pgg";
    iov[0].iov_len = 59;
