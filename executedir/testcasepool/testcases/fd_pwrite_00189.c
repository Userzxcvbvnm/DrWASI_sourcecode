...
void fd_pwrite_00189_nEEKq(int fd) {
    printf("Enter function fd_pwrite_00189_nEEKq\n");
    off_t size = lseek(fd, 0, SEEK_END); 
    printf("Current file size before: %ld\n", size);

    
    struct iovec iov[1];
    iov[0].iov_base = "PsPiIYBPduGxj2DRYCtuwqSN12WHgXFgJFkSlZ5U3pLCPgik0j18mbRHTcuBDdbgvoG7vlnIkMzSsULQxjKeJSWdOhXpAhE8usALYPn8L7IjJUrvH";
    iov[0].iov_len = 113;
