...
int fd_filestat_get_00004_1s23e(int fd) {
    printf("Enter function fd_filestat_get_00004_1s23e.\n");
    ...
    printf("Leaver fd_filestat_get_00004.\n");
    return 0;
}
...
int main() {
    ...
    fd_filestat_get_00004_1s23e(fd);
