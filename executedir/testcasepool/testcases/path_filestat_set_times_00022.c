...
void path_filestat_set_times_00022_WD7wr(int fd, const char *pathname) {

    printf("Enter function path_filestat_set_times_00022_WD7wr\n");
...
int main() {
    ...
    path_filestat_set_times_00022_WD7wr(fd, "EXAMPLEFILE");
