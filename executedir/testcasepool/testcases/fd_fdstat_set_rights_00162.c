...
int fd_fdstat_set_rights_00162_7we45(int fd) {
    printf("Enter function fd_fdstat_set_rights_00162_7we45\n");

    __wasi_rights_t new_rights = __WASI_RIGHTS_PATH_READLINK;
...
int main() {
    ...
    fd_fdstat_set_rights_00162_7we45(fd);
