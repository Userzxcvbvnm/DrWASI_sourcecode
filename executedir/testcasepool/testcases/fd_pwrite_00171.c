...
void fd_pwrite_00171_nEEKq(int fd) {
    printf("Enter function fd_pwrite_00171_nEEKq\n");
    off_t size = lseek(fd, 0, SEEK_END); 
    printf("Current file size before: %ld\n", size);

    
    struct iovec iov[1];
    iov[0].iov_base = "qYrJyzQfpUCy10r1RETPWzOYBg1SMuJDH6LpfIqvUWITqf2FwfeOwcF6tgelS2q3Otx";
    iov[0].iov_len = 67;
